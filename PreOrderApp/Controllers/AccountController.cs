...
namespace PreOrderApp.Controllers
{
	...
	public class AccountController : Controller
	{
		...
		{
			var people = _database.UserProfiles.Include("webpages_Roles");
			UserProfile[] users = people.ToArray();
		...
		{
			ViewBag.RoleId = new SelectList(_database.webpages_Roles.Where(roles => roles.RoleName != "Administrator"), "RoleId", "RoleName");
			return View();
		}
